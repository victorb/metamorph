const { getFrequentlyUsedFiles } = require('../utils/code_usage_tracker');

const threshold = 3;
const frequentlyUsedFiles = getFrequentlyUsedFiles(threshold);
...
- Prioritize improvements on frequently edited or frequently used parts of the code: ${frequentlyUsedFiles.join(', ')}
